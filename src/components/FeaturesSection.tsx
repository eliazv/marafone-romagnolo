      ...
      <div className="container mx-auto relative z-10 max-w-6xl">
        ...
        <FadeInUp delay={0.8}>
          <div className="bg-gradient-to-br from-marafone-red/5 to-marafone-yellow/5 rounded-2xl p-8 md:p-12 border border-marafone-red/10">
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mb-10">
              <StaggerItem>
            ...
            {/* Torneo Bar Rita */}
            <div className="mt-10 pt-8 border-t border-marafone-red/20">
              <h4 className="font-retro text-xl md:text-2xl text-marafone-dark text-center mb-6">
                🏆 Torneo Settimanale - Bar Rita
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
                <div className="flex items-center justify-center gap-2 text-marafone-dark/80">
                  <Calendar className="h-5 w-5 text-marafone-red" />
                  <span className="font-game">Ogni Martedì ore 20:15</span>
                </div>
                <div className="flex items-center justify-center gap-2 text-marafone-dark/80">
                  <Euro className="h-5 w-5 text-marafone-red" />
                  <span className="font-game">Iscrizione: 10€</span>
                </div>
                <div className="flex items-center justify-center gap-2 text-marafone-dark/80">
                  <MapPin className="h-5 w-5 text-marafone-red" />
                  <a
                    href="https://maps.app.goo.gl/AGs7pc21DxtWokho6"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-game hover:text-marafone-red transition-colors"
                  >
                    Via Ravegnana 357, Ravenna
                  </a>
                </div>
              </div>
            </div>
