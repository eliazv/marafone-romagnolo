...
const ScreenshotsSection = () => {
  const screenshots = [
    ...
    },
    {
      ...
      description:
        "L'interfaccia ricrea fedelmente l'atmosfera del tavolo da bar romagnolo. Le carte sono grandi e ben leggibili, perfette anche per smartphone. Durante la partita puoi vedere il punteggio in tempo reale, le carte giocate, e ricevere suggerimenti su quali mosse fare. Il sistema tiene traccia automaticamente di tutti i punti: dalle \"mazze\" ai \"bussi\", fino alla famosa \"ultima\".",
    },
  ];
    ...
    <section className="relative py-20 px-4 bg-white overflow-hidden">
      <div className="container mx-auto relative z-10 max-w-6xl">
        <div className="space-y-20">
          ...
          {/* Sezione statistiche con screenshot */}
          <StaggerItem>
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              >
                ...
                >
                  <img
                    src="/img/screen-playstore/Screenshot 2025-11-14 194523.png"
                    alt="Community e classifiche"
                    className="object-cover w-full rounded-2xl shadow-lg"
                    loading="lazy"
                  />
                </motion.div>
              ...
              <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.3 }}
              >
                <div className="bg-gradient-to-br from-marafone-red/5 to-marafone-yellow/5 rounded-2xl p-8 md:p-10 border border-marafone-red/10">
