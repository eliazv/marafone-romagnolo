    ...
    <div className="min-h-screen bg-marafone-beige text-marafone-dark py-4 px-4">
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 border-2 border-marafone-yellow">
        ...
        <p className="font-game mb-4">
          Benvenuti in Maraffa Romagnola. La vostra privacy è importante per
          noi. Questa Privacy Policy descrive come raccogliamo, utilizziamo e
        ...
        <p className="font-game mb-2">
          I dati sono archiviati in cloud attraverso <strong>Supabase</strong>,
          un servizio sicuro e compatibile con GDPR, e una parte viene salvata
          nel dispositivo localmente (per performance e uso offline).
        </p>
        ...
        <p className="font-game mb-2">
          L'app non è pensata per bambini sotto i 13 anni. L'autenticazione
          Google può richiedere un’età minima di 16 anni in alcuni paesi europei
          secondo GDPR.
        </p>
        ...
        <p className="font-game mb-2">
          ...
          gli utenti direttamente nell'app ogni volta che verrà modificata in
          modo sostanziale.
        </p>
